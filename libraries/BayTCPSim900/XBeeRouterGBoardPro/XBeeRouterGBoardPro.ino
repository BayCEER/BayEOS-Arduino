/*
  WARNING: THIS SKETCH WILL NOT COMPILE WITH ARDUINO 1.6.X
  IT USES A HARDWARESERIAL HACK THAT MAY BE UNSTABLE!!!

  A newer version can be found in libraries/BayHardwareSerialPlus
