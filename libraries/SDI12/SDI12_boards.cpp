 ...
 *
 * Adjusted by S. Holzheu to run with timer1
 *
 */
 ...
 */
static uint8_t preSDI12_TCCR1B;

#if F_CPU == 16000000L

void SDI12Timer::configSDI12TimerPrescale(void) {
  preSDI12_TCCR2A = TCCR1A;
  preSDI12_TCCR2B = TCCR1B;
  TCCR1A = 0x00;  // TCCR1A = 0x00 = "normal" operation - Normal port operation, OC1A &
                  // OC1B disconnected
  TCCR1B = 0x05;  // TCCR1B = 0x05 = 0b00000101 - prescaler set to CK/1024
}
void SDI12Timer::resetSDI12TimerPrescale(void) {
  TCCR1A = preSDI12_TCCR1A;
  TCCR1B = preSDI12_TCCR1B;
}
...
void SDI12Timer::configSDI12TimerPrescale(void) {
  ...
  TCCR1A = 0x00;  // TCCR1A = 0x00 = "normal" operation - Normal port operation, OC1A &
                  // OC1B disconnected
  TCCR1B = 0x04;  // TCCR1B = 0x06 = 0b00000100 - rescaler set to CK/256
}
void SDI12Timer::resetSDI12TimerPrescale(void) {
  TCCR1A = preSDI12_TCCR1A;
  TCCR1B = preSDI12_TCCR1B;
