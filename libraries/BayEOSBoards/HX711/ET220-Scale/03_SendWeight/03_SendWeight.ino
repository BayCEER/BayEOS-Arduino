/*
 * This sketch sends the calibrated weight of a 4 HX711 scale
 * 
 * Make sure you have valid calibration data in EEPROM!!
 */
...
void loop() {
  if (ISSET_ACTION(0)) {
    ...
    if(adc!=0xf0000000)
      client.addChannelValue(cal.getWeight(adc,t_mean));
#if WITH_CHECKSUM
    client.addChecksum();
#endif
    sendOrBufferLCB();
