...
unsigned char tx_buffer2[16];
unsigned char rx_buffer2[16];

HardwareSerialPlus SerialPlus2(&UBRR2H, &UBRR2L, &UCSR2A, &UCSR2B, &UCSR2C, &UDR2,rx_buffer2,16,tx_buffer2,16);
